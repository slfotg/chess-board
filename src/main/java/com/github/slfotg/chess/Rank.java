...
public enum Rank {
    ...
    public static final Rank[] FEN_ORDERED_RANKS = new Rank[] { EIGHT, SEVEN, SIX, FIVE, FOUR, THREE, TWO, ONE };
    public static final Rank[] ORDERED_RANKS = new Rank[] { ONE, TWO, THREE, FOUR, FIVE, SIX, SEVEN, EIGHT };
